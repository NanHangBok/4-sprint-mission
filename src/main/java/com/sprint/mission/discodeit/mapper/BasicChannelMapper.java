...
//
//@Component
//public class BasicChannelMapper {
...
//    }
//
//    public ChannelDto ofChannelDto(Channel channel, Instant latestMessageTime, List<UserDto> userDtos) {
//        return new ChannelDto(channel.getId(), channel.getType(), channel.getChannelName(), channel.getDescription(), userDtos, latestMessageTime);
//    }
//
//    public ChannelDto toChannelDto(Channel channel) {
//        return new ChannelDto(channel.getId(), channel.getType(), channel.getChannelName(), channel.getDescription(), null, null);
//    }
//
//    public ChannelDto ofChannelDto(Channel channel, List<UserDto> userDtos) {
//        return new ChannelDto(channel.getId(), channel.getType(), channel.getChannelName(), channel.getDescription(), userDtos, null);
//    }
//
//    public ChannelDto ofChannelDtoFromPublicChannel(Channel channel, Instant latestMessageTime) {
//        return new ChannelDto(channel.getId(), channel.getType(), channel.getChannelName(), channel.getDescription(), null, latestMessageTime);
//    }
//}
